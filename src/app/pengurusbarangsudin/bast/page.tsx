...
import LayoutPengurusBarangSudin from '../../components/LayoutPengurusBarangSudin'
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-wrap gap-4 items-end">
          <div>
            ...
            >
              <option>Sudin Jakarta Utara</option>
              <option value="2.11">Sudin Jakarta Utara Sektor Penjaringan</option>
              <option value="2.12">Sudin Jakarta Utara Sektor Tanjung Priok</option>
              <option value="2.13">Sudin Jakarta Utara Sektor Koja</option>
              <option value="2.14">Sudin Jakarta Utara Sektor Cilincing</option>
              <option value="2.15">Sudin Jakarta Utara Sektor Pademangan</option>
              <option value="2.16">Sudin Jakarta Utara Sektor Kelapa Gading</option>
              <option value="2.17">Sudin Jakarta Utara Sektor Kepulauan Seribu Utara</option>
              <option value="2.18">Sudin Jakarta Utara Sektor Kepulauan Seribu Selatan</option>
              <option value="2.4">Sudin Jakarta Utara Seksi Operasi</option>
              <option value="2.6">Sudin Jakarta Utara Subbagian Tata Usaha</option>
              <option value="2.7">Sudin Jakarta Utara Seksi Sarana Operasi</option>
              <option value="2.8">Sudin Jakarta Utara Seksi Pencegahan Kebakaran</option>
            </select>
          </div>
          <div>
                ...
                <tr className="border-t">
                  ...
                  <td className="px-4 py-2">
                    <ul className="list-disc list-inside space-y-1">
                      <li>Sektor Koja: 20 unit</li>
                      <li>Sektor Cilincing: 15 unit</li>
                      <li>Sektor Pademangan: 10 unit</li>
                    </ul>
                  </td>
                  <td className="px-4 py-2">
