...
import DistribusiBarangChartSudin from '../../components/DistribusiBarangChartSudin'
    ...
    items: [
      {
        ...
        progress: 90,
        wilayah: [
          { nama: 'Sektor Pademangan', jumlah: 40 },
          { nama: 'Sektor Penjaringan', jumlah: 30 },
          { nama: 'Sektor Kelapa Gading', jumlah: 20 },
        ],
      },
      {
        ...
        progress: 83,
        wilayah: [
          { nama: 'Sektor Koja', jumlah: 30 },
          { nama: 'Sektor Cilincing', jumlah: 20 },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        progress: 90,
        wilayah: [
          { nama: 'Sektor Cilincing', jumlah: 40 },
          { nama: 'Sektor Tanjung Priok', jumlah: 30 },
          { nama: 'Sektor Koja', jumlah: 20 },
        ],
      },
      {
        nama: 'Sarung Tangan (SafeGrip)',
        ...
        wilayah: [
          { nama: 'Sektor Koja', jumlah: 30 },
          { nama: 'Sektor Penjaringan', jumlah: 20 },
        ],
      },
    ],
  },
