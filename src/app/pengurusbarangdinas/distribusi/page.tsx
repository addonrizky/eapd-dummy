...
import DistribusiBarangChart from '../../components/DistribusiBarangChart'
    ...
    items: [
      {
        ...
        progress: 90,
        wilayah: [
          { nama: 'Jakarta Selatan', jumlah: 40 },
          { nama: 'Jakarta Timur', jumlah: 30 },
          { nama: 'Pusdiklatkar', jumlah: 20 },
        ],
      },
      {
        ...
        progress: 83,
        wilayah: [
          { nama: 'Jakarta Barat', jumlah: 30 },
          { nama: 'Jakarta Utara', jumlah: 20 },
        ],
      },
    ],
  },
